...
public interface Memory<C extends Cell> {
	...
	/**
	 * Make sure that the two selected card will be displayed in the future.
	 * 
	 ...
	 * 
	 * By default, the game should end when all the pairs have been found. Another
	 * possibility would be to end the game after a given number of trials.
	 * 
